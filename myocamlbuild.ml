(* OASIS_START *)
(* DO NOT EDIT (digest: aecf657a19456a1e39ad5b2287fd9a7f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("veri", ["lib"], []); ("veri_test", ["tests"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_veri_byte"; "ocaml"; "link"; "byte"],
            [
          ...
          (["oasis_library_veri_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_veri_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_veri_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_veri_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_veri_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true,
                 S
                   [
